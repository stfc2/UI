...
if(isset($_GET['action'])) {
  ...
  if($_GET['action']=='user') {
    ...
    $anfang = '<table><tr><td width="75">Platz:</td><td width="175">Name:</td><td width="125">Allianz:</td><td width="125">Planeten</td><td width="100">Punkte:</td><td width="100">Verdienst:</td></tr>';
    $ende = '</table>';
    ...
    $pdf->Cell(0, 10, 'Aktuelles STFC2 User-Ranking', 'B', 1); 
    ...
    $anfang = '<table><tr><td width="75">Platz:</td><td width="100">Tag:</td><td width="250">Name:</td><td width="100">Member:</td><td width="100">Planeten:</td><td width="85">Verdienst:</td><td width="85">Punkte:</td><td width="85">Punkte Ø :</td></tr>'; 
    $ende = '</table>';
    ...
    $pdf->Cell(0, 10, 'Aktuelles STFC2 Allianz-Ranking', 'B', 1); 

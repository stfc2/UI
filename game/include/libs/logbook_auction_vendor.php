            ...
            <table border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td width="450">
                  ...
                  '.constant($game->sprache("TEXT124")).' "<a href="'.parse_link('&a=trade&view=view_bidding_detail&id='.$log['log_data']['auction_id']).'">'.$log['log_data']['auction_name'].'</a>" '.constant($game->sprache("TEXT125")).'
                  ...
                  '.constant($game->sprache("TEXT126")).' <a href="'.parse_link('a=stats&a2=viewplayer&id='.$log['log_data']['player_id']).'">'.$log['log_data']['player_name'].'</a><br><br>
                  '.constant($game->sprache("TEXT127")).'
                </td>
              </tr>
            </table>
          </td>

...
foreach ($ship_components_locale[4] as $category => $foo2)
{
	$ship_components[4][$category]['name'] = $ship_components_locale[4][$category]['name'];

	foreach ($ship_components_locale[4][$category] as $component => $foo3)
	{
		$ship_components[4][$category][$component]['name'] = $ship_components_locale[4][$category][$component]['name'];
		$ship_components[4][$category][$component]['description'] = $ship_components_locale[4][$category][$component]['description'];
	}
}

...
1=>array(
        ...
        0=>array(
             ...
             // Component Nucleo curvatura V
             4=>array(
                    'name'=>'Nucleo curvatura V',
                    'description'=>'Flavor Text Here.',
            ), // Endof Component Nucleo curvatura V

             // Component Nucleo curvatura VI
             5=>array(
                    'name'=>'Nucleo curvatura VI',
                    'description'=>'Flavor Text Here.',
            ), // Endof Component Nucleo curvatura VI

             // Component Nucleo curvatura VII
             6=>array(
                    'name'=>'Nucleo curvatura VII',
                    'description'=>'Flavor Text Here.',
            ), // Endof Component Nucleo curvatura VII

             // Component Nucleo curvatura VIII
             7=>array(
                    'name'=>'Nucleo curvatura VIII',
                    'description'=>'Flavor Text Here.',
            ), // Endof Component Nucleo curvatura VIII
      ...
      'name'=>'Sala Macchine',
        ...
        1=>array(
             ...
             // Component Warpspulen
             1=>array(
                    'name'=>'Bobine di curvatura II',
                    'description'=>'Le bobine di curvatura standard rappresentano i sistemi di base per raggiungere velocit&agrave; trans-luce.',
            ), // Endof Component Warpspulen

             // Component Warpspulen
             2=>array(
                    'name'=>'Bobine di curvatura III',
                    'description'=>'Le bobine di curvatura standard rappresentano i sistemi di base per raggiungere velocit&agrave; trans-luce.',
            ), // Endof Component Warpspulen
      ...
      'name'=>'Propulsori',
        ...
        2=>array(
             ...
             // Component Disgregatore MK V
             1=>array(
                    'name'=>'Disgregatore MK V',
                    'description'=>'Modello di disgregatore potenziato rispetto al IV ma decisamente ancora debole.',
            ), // Endof Component Disgregatore MK V

             // Component Disgregatore MK VI
             2=>array(
                    'name'=>'Disgregatore MK VI',
                    'description'=>'Il Disgregatore MK VI raggiunge un livello di potenza discreto rispetto ai suoi predecessori.',
            ), // Endof Component Disgregatore MK VI

             // Component Disgregatore MK VII
             3=>array(
                    'name'=>'Disgregatore MK VII',
                    'description'=>'Elevato potere distruttivo, decisamente fatale se impiegato contro vascelli piccoli.',
            ), // Endof Component Disgregatore MK VII
            
             // Component Cannone al plasma II
             4=>array(
                    'name'=>'Cannone al plasma II',
                    'description'=>'Flavor Text Here.',
            ), // Endof Component Cannone al plasma II            
             ...
             // Component Disgregatore  MK IX
             6=>array(
                    'name'=>'Disgregatore MK IX',
            ...
            ), // Endof Component Disgregatore  MK IX

             // Component Cannone al plasma III
             7=>array(
                    'name'=>'Cannone al plasma III',
                    'description'=>'Flavor Text Here.',
            ), // Endof Component Cannone al plasma III
      ...
      'name'=>'Armi primarie',
        ...
        3=>array(
             ...
             0=>array(
                    ...
                    'description'=>'Flavor Text Here.',
            ), // Endof Component Siluri Fotonici
             ...
             // Component Lanciatore Multiplo
             3=>array(
                    'name'=>'Lanciatore Multiplo',
                    'description'=>'Flavor Text Here.',
            ), // Endof Component Lanciatore Multiplo
             ...
             6=>array(
                    ...
                    'description'=>'I siluri al plasma rappresentano lo stadio finale dello sviluppo di questa tecnologia. L&#146;enorme consumo di energia di questo sistema d&#146;arma ne rende possibile l&#146;impiego solo sulle navi da guerra maggiori.',
      ...
      'name'=>'Postazione scientifica',
        ...
        8=>array(
             ...
             // Component Scudi Secondari
             2=>array(
                    'name'=>'Scudi Secondari',
                    'description'=>'Flavor Text Here.',
            ), // Endof Component Scudi Secondari            
            
             // Component Cannone Disgregatore
             3=>array(
                    'name'=>'Cannone Disgregatore',
                    'description'=>'Flavor Text Here.',
            ), // Endof Component Cannone Disgregatore            

             // Component Scudi Secondari II            
             4=>array(
                    'name'=>'Scudi Secondari II',
                    'description'=>'Flavor Text Here.',
            ), // Endof Component Scudi Secondari II
...
foreach ($ship_components_locale[1] as $category => $foo2)
{
	$ship_components[1][$category]['name'] = $ship_components_locale[1][$category]['name'];

	foreach ($ship_components_locale[1][$category] as $component => $foo3)
	{
		$ship_components[1][$category][$component]['name'] = $ship_components_locale[1][$category][$component]['name'];
		$ship_components[1][$category][$component]['description'] = $ship_components_locale[1][$category][$component]['description'];
	}
}

...
foreach ($ship_components_locale[8] as $category => $foo2)
{
	$ship_components[8][$category]['name'] = $ship_components_locale[8][$category]['name'];

	foreach ($ship_components_locale[8][$category] as $component => $foo3)
	{
		$ship_components[8][$category][$component]['name'] = $ship_components_locale[8][$category][$component]['name'];
		$ship_components[8][$category][$component]['description'] = $ship_components_locale[8][$category][$component]['description'];
	}
}

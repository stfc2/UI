...
foreach ($ship_components_locale[3] as $category => $foo2)
{
	$ship_components[3][$category]['name'] = $ship_components_locale[3][$category]['name'];

	foreach ($ship_components_locale[3][$category] as $component => $foo3)
	{
		$ship_components[3][$category][$component]['name'] = $ship_components_locale[3][$category][$component]['name'];
		$ship_components[3][$category][$component]['description'] = $ship_components_locale[3][$category][$component]['description'];
	}
}

...
foreach ($ship_components_locale[0] as $category => $foo2)
{
	$ship_components[0][$category]['name'] = $ship_components_locale[0][$category]['name'];

	foreach ($ship_components_locale[0][$category] as $component => $foo3)
	{
		$ship_components[0][$category][$component]['name'] = $ship_components_locale[0][$category][$component]['name'];
		$ship_components[0][$category][$component]['description'] = $ship_components_locale[0][$category][$component]['description'];
	}
}

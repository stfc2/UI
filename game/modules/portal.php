...
function display_news() {
    ...
    $game->out('
<table border="0" cellpadding="2" cellspacing="2" width="100%" class="style_outer">
  <tr>
    <td align="center">
      ...
      <tr>
        <td width="100%" valign="top">
          <table border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr>
              <td valign="top" align="center">'.$skin['skin_portal_desc'].'<br><a href="template_manager.php?change_skin='.$skin['skin_id'].'" target="_blank"><img src="'.$skin['skinpreview_link'].'" border="0"></a><br><a href="'.$skin['gfxpack_link'].'">'.constant($game->sprache("TEXT10")).'</a></td>
            </tr>
          </table>
        </td>
      </tr>

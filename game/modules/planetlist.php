...
foreach ($planets as $key => $planet) {
	...
	if (isset($planet['research_id'])) $status.='<td width=12><a href="javascript:void(0);" onmouseover="return overlib(\''.$research.'\', CAPTION, \''.constant($game->sprache("TEXT26")).'\', WIDTH, 350, '.OVERLIB_STANDARD.');" onmouseout="return nd();"><font color='.$research_color.'>'.constant($game->sprache("TEXT30")).'</font></a></td>'; else $status.='<td width=12>&nbsp;</td>';

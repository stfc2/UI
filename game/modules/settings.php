...
$uploaddir = '/root/stfc/game2/gallery/';
      ...
      <table width="400" border="0" cellpadding="0" cellspacing="0" class="style_inner">
	   ...
	   <td>&nbsp;</td>
        ...
        <tr>
          ...
          <td><input type="checkbox" name="user_enable_sig" value="1"'.( ($data['user_enable_sig']) ? ' checked="checked"' : '' ).'> '.constant($game->sprache("TEXT29")).'<br>(<a href="'.$config['game_url'].'/game2/sig_tmp/'.strtolower($game->player['user_name']).'.jpg" target=_blank>'.$config['game_url'].'/game2/sig.php?user='.$game->player['user_name'].'</a>)<br>
...
*/
    ...
    case 'delete_account':
        ...
        if(!empty($_POST['submit_del'])) {
            ...
            $confirm_link = $config['game_url'].'/index.php?a=delete&galaxy=1&user_id='.$game->player['user_id'].'&key='.$confirm_key;
